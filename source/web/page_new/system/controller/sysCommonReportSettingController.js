 ...
 * 系统菜单相关的controller
 */
infopowerWebApp.controller('sysCommonReportSettingCtrl', ['$scope', '$http', '$controller', '$routeParams','$stateParams',
    function ($scope, $http, $controller, $routeParams,$stateParams) {
        ...
        $scope.confirmCommonReportSetting = function (menuId) {
            $('#btnConfirmCommonSettingReport').one('click', function () {
                ...
                $scope.postApi('sysUserPersonalizedSetting/confirmSettingReport.do', {
                    menuId: $scope.menuid,
                    confirmmenuId: menuId,
                    settingType: '01'
                }, function (result) {
        ...
        $scope.cancelCommonReportSetting = function (menuId) {
            ...
            $('#btnCancelCommonConfirm').one('click', function () {
                $scope.postApi('sysUserPersonalizedSetting/cancelSettingReport.do', {
                    menuId: $scope.menuid,
                    cancelmenuId: menuId,
                    settingType: '01'
                }, function (result) {
        ...
        function getSysMenuParent() {
            $scope.getApi('sysMenu/getSysMenuList.do', {
                menuType: "02",
                menuAttribute: "0",
                menuStatus: "1"
            }, function (datas) {
