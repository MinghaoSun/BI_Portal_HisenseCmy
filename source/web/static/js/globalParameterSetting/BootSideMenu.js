(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		this.addClass("container sidebar2");

		if(side=="left"){
			this.addClass("sidebar2-left");
		}else if(side=="right"){
			this.addClass("sidebar2-right");
		}else{
			this.addClass("sidebar2-left");
		}
	...
	$(document).on('click', '.sidebar2 .list-group-item', function(){
		$('.sidebar2 .list-group-item').each(function(){
	...
	$(document).on('click', '.sidebar2 .list-group-item', function(event){
...
//restituisce il lato del sidebar2 in base alla classe che trova settata
function getSide(listaClassi){
	var side;
	for(var i = 0; i<listaClassi.length; i++){
		if(listaClassi[i]=='sidebar2-left'){
			side = "left";
			break;
		}else if(listaClassi[i]=='sidebar2-right'){
			side = "right";
			break;
		}else{
			side = null;
